function DigitalToolbox() {
  const tools = [
    ...
    },
    {
      ...
      title: 'Expert Chat',
      description: 'Connect with agriculture experts for personalized advice and problem-solving.',
      color: 'bg-pink-500',
    },
    {
      icon: (
    ...
    <section id="tools" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Digital Toolbox</h2>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Access powerful digital tools designed to make farming easier and more profitable
          </p>
        </div>
