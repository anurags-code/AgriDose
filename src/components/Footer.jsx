      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-1">
            <span className="text-2xl font-bold text-green-400">SmartFarm</span>
            <p className="mt-4 text-gray-400 text-sm">
              Empowering Indian farmers with technology-driven solutions for better yields and sustainable agriculture.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Expert Articles</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>support@smartfarm.in</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-0.5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
